      ...
      <div className="container mx-auto px-4">
        <motion.div variants={containerVariants} initial="hidden" animate={isInView ? "visible" : "hidden"}>
          ...
          <motion.div variants={titleVariants} className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-semibold text-[#1C1C1C] max-w-4xl mx-auto">
            ...
            {features.map((feature, index) => (
              ...
              >
                <motion.div whileHover={{ scale: 1.1, rotate: 5 }} className="w-16 h-16 mx-auto mb-4">
                  <img
                    src={feature.icon || "https://placehold.co/64x64/E0E0E0/333333?text=Icon"}
                    alt={feature.title}
                    className="w-full h-full object-contain"
                  />
                </motion.div>

                <h3 className="text-lg font-semibold text-[#1C1C1C] mb-3">{feature.title}</h3>
