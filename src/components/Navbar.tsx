...
const Navbar = ({ onNavigate, currentPath }) => {
  ...
  const navItems = [
    { name: TEXTS.Navbar.nav.home, path: '/' },
    { name: TEXTS.Navbar.nav.about, path: '/about' },
    { name: TEXTS.Navbar.nav.services, path: '/services' },
    { name: TEXTS.Navbar.nav.blog, path: '/blog' },
    { name: TEXTS.Navbar.nav.contact, path: '/contact' },
  ];
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="lg:hidden flex items-center">
            <button
              ...
              aria-label={TEXTS.Navbar.menuLabel}
            >
