...
const services = [
  ...
  },
  {
    ...
    description:
      "يوفر شركاء الدقة لخدمات الأعمال استشارات محاسبية متخصصة للمشاريع الناشئة، مساهمًا في توجيهها نحو النجاح وتطويرها بشكل فعّال.",
  ...
  },
  {
    ...
    title: "الموازنات",
    description:
      "يتعاون شركاء الدقة لخدمات الأعمال مع العملاء في وضع موازنات دقيقة تعكس رؤية مالية شاملة وتسهم في تحقيق الأهداف المالية المستقبلية.",
  ...
  },
  {
    ...
    description:
      "يدير شركاء الدقة لخدمات الأعمال الالتزامات المتعلقة بضريبة الاستقطاع بكفاءة، مما يضمن استيفاء الالتزامات الضريبية بدقة وفقًا للتشريعات السارية.",
