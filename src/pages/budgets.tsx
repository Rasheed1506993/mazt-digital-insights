      ...
      >
        ...
        <div className="container mx-auto px-4 h-full flex items-center">
          ...
          >
            ...
            >
خدمة استشارات الموازنات من مكتب المازن تساعد في تحقيق التوازن المالي وتحقيق الأهداف الاستراتيجية للشركات والمنشآت، خلال عملية حيوية تسهم في فحص وتحليل الإيرادات والنفقات الكلية على مدى فترة زمنية معينة، بهدف تحقيق التوازن الفعّال بينها وبين تحقيق أهداف الشركة على المدى القصير والطويل.
            </motion.p>
            <motion.button
...
أهداف خدمة استشارات الموازنات من مكتب المازن:
              </p>
            </motion.div>
          </div>
